...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="<?php echo yii\helpers\Url::to(['/index/index']) ?>" style="font-weight:700;font-family:Microsoft Yahei">结伴旅行信息发布平台 - 后台管理</a>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                <li><a href="<?php echo yii\helpers\Url::to(['plan/plans']); ?>">结伴信息列表</a></li>
                </ul>
            </li>
        </ul>
    </div>
